<template>
  <AdminLayout title="Data Customer">
...
const submitCreate = () => {
  router.post(route('admin.customer.store'), createForm.value, {
    onSuccess: () => {
...
const submitEdit = () => {
  router.put(route('admin.customer.update', editForm.value.id), editForm.value, {
    onSuccess: () => {
